...
const energized = energy.reduce((a, b) => a + b.reduce((a, { up, right, down, left }) => a + Number(up || right || down || left), 0), 0);

console.log(`There are ${energized} tiles end up being energized`);
